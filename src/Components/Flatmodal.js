      ...
      arrObj: [
        {
          title: "First Item",
          content:
            "lorem ipsium tipsium ripsium chipsium this content is for demo"
        },
        {
          title: "Second Item",
          content:
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          <Text style={{ textAlign: "center", padding: 20 }}>{saveTitle}</Text>
          ...
          >
            <View>
              <Text style={{ textAlign: "center" }}>Press To Navigate</Text>
            </View>
          </TouchableOpacity>
        </Modal>
      </SafeAreaView>
